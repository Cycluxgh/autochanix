<x-slot:account>
    ...
    <div class="text-center text-muted mb-4">
        <p class="mb-0">Already have an account ?<a class='text-primary ms-2 fw-medium' href='/' wire:navigate>Login</a></p>
    </div>
</x-slot>
<x-slot:oauth>
    <div class="row">
...
<div>
    ...
    <form class="my-4" wire:submit="register">
        <div class="form-group mb-3">
            ...
            <input class="form-control" name="name" type="text" id="username" required="" placeholder="Enter your name" wire:model="name">
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <div class="input-group">
                <input class="form-control" type="password" required="" id="register-password" placeholder="Enter your password" wire:model="password">
                <span class="input-group-text" onclick="onRegisterPasswordVisible()" style="cursor: pointer"><i class="mdi mdi-lock-outline fs-16 align-middle" id="register-lock-icon"></i></span>
            </div>
        </div>
