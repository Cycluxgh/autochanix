<x-slot:account>
    ...
    <div class="text-center text-muted mb-4">
        <p class="mb-0">Don't have an account ?<a class='text-primary ms-2 fw-medium' href='/register' wire:navigate>Register</a></p>
    </div>
</x-slot>
<x-slot:oauth>
    <div class="row">
...
<div>
    ...
    @endif
    <form class="my-4 novalidated" wire:submit="login">
        <div class="form-group mb-3">
            <label for="emailaddress" class="form-label">Email address</label>
            <input class="form-control" type="email" name="email" id="emailaddress" required placeholder="Enter your email" wire:model="email">
            @error('email')
        ...
        <div class="form-group mb-3">
            ...
            <div class="input-group">
                <input class="form-control" type="password" name="password" id="password" required placeholder="Enter your password" wire:model="password">
                <span class="input-group-text" onclick="onLoginPasswordVisible()"  style="cursor: pointer"><i class="mdi mdi-lock-outline fs-16 align-middle" id="login-lock-icon"></i></span>
            </div>
            @error('password')
            <div class="invalid-feedback">
                {{ $message }}
        ...
        <div class="form-group d-flex mb-3">
            <div class="col-sm-6">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="checkbox-signin" checked wire:model="rememberMe">
                    <label class="form-check-label" for="checkbox-signin">Remember me</label>
                </div>
            </div>
            <div class="col-sm-6 text-end">
                <a class='text-muted fs-14' href='/forgot-password' wire:navigate>Forgot password?</a>
            </div>
        </div>
