        ...
        <div id="sidebar-menu">
            ...
            <div class="logo-box">
                <a href="/" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                                    <img src="{{asset('assets/images/logo-light.png')}}" alt="" height="100" width="200">
                                </span>
                </a>
                <a href="/" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                                    <img src="{{asset('assets/images/logo-dark.png')}}" alt="" height="100" width="200">
                                </span>
                </a>
            </div>
...
{{--                    </div>--}}
                ...
                <li>
                    <a href="#sidebarAuth" data-bs-toggle="collapse">
                        <i class="mdi mdi-car-2-plus fs-16 align-middle"></i>
...
{{--                            </li>--}}
                ...
                <li>
                    <a href="#sidebarError" data-bs-toggle="collapse">
                        <i class="mdi mdi-car-wrench fs-16 align-middle"></i>
                        <span> Mechanics </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="sidebarError">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('mechanics.create') }}" class="tp-link">Add</a>
                            </li>
                            <li>
                                <a href="{{ route('mechanics.index') }}" class="tp-link">List</a>
                            </li>
{{--                            <li>--}}
