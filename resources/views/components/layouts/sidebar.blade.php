    ...
    <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                <li>
                    <a href="/dashboard/statistics" data-bs-toggle="collapse" wire:navigate.hover>
...
{{--                        <ul class="nav-second-level">--}}
{{--                            <li>--}}
{{--                                <a href="/complaint/create" class="tp-link" wire:navigate>Add</a>--}}
{{--                            </li>--}}
{{--                            <li>--}}
